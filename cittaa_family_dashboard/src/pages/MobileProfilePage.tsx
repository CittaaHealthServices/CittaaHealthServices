...
export default function MobileProfilePage() {
  ...
  const copyDownloadUrl = (token: string) => {
    const downloadUrl = `https://user:1af8d504a70e676be22fe020844d99c8@invisible-parental-control-app-tunnel-wg23lz5v.devinapps.com/mobile-profile/download/${token}`;
