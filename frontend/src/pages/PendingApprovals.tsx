    ...
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <h1 className="text-2xl font-bold text-primary-800">Pending Approvals</h1>
          <p className="text-sm text-primary-600">Review and approve clinical trial participants</p>
        </div>
      </div>
